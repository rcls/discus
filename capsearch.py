...
fast('rnpn_r_lo', 48, 49, npn22_r, FACTOR=0.1, TARGET=LOGIC, CRIT='inc')

fast('rnpn_r_hi_fast', 55, 54, npn22_r, TARGET=LOGIC, CRIT='cmp inc')
...
fast('pmos_vto_lo', 27, 28, pmos_vto, FACTOR=10e-3, EXTRA=[(delay_res, 820)],
     CRIT='call memp')
