v 20220529 2
C -3800 1200 1 0 0 in-1.sym
{
T -3800 1700 5 10 0 0 0 0 1
footprint=anchor
T -3800 1500 5 10 0 0 0 0 1
device=INPUT
T -3800 1300 5 10 1 1 0 7 1
refdes=B
}
C -3800 1900 1 0 0 in-1.sym
{
T -3800 2400 5 10 0 0 0 0 1
footprint=anchor
T -3800 2200 5 10 0 0 0 0 1
device=INPUT
T -3800 2000 5 10 1 1 0 7 1
refdes=W
}
...
C -1600 1200 1 0 1 in-1.sym
{
T -1600 1700 5 10 0 0 0 6 1
footprint=anchor
T -1600 1500 5 10 0 0 0 6 1
device=INPUT
T -1600 1300 5 10 1 1 0 1 1
refdes=WE#
}
C -3200 1000 1 0 0 pmos-switch.sym
{
T -2975 1300 5 8 1 1 0 1 1
refdes=M3
T -3100 1800 5 10 0 1 0 0 1
value=PMOS_switch
T -2700 1600 5 10 0 1 0 0 1
footprint=sot23-pmos
T -1700 1600 5 10 0 1 0 0 1
device=PMOS
}
C -3200 1700 1 0 0 pmos-switch.sym
{
T -2975 2000 5 8 1 1 0 1 1
refdes=M1
T -3100 2500 5 10 0 1 0 0 1
value=PMOS_switch
T -2700 2300 5 10 0 1 0 0 1
footprint=sot23-pmos
T -1700 2300 5 10 0 1 0 0 1
device=PMOS
}
C -2200 1000 1 0 1 pmos-switch.sym
{
T -2425 1300 5 8 1 1 0 7 1
refdes=M4
T -2300 1800 5 10 0 1 0 6 1
value=PMOS_switch
T -2700 1600 5 10 0 1 0 6 1
footprint=sot23-pmos
T -3700 1600 5 10 0 1 0 6 1
device=PMOS
}
N -2600 1500 -2600 1800 4
N -2800 2400 -2600 2400 4
N -2800 1800 -2800 1500 4
N -2800 1100 -2800 900 4
N -2600 900 -2600 1100 4
N -2600 2400 -2600 2200 4
C 500 -1600 1 0 1 in-1.sym
{
T 500 -1100 5 10 0 0 0 6 1
footprint=anchor
T 500 -1300 5 10 0 0 0 6 1
device=INPUT
T 500 -1500 5 10 1 1 0 1 1
refdes=ϕ1##
}
...
C -100 -1800 1 0 1 nmos-switch.sym
{
T -325 -1500 5 8 1 1 0 7 1
refdes=M7
T -200 -1000 5 10 0 1 0 6 1
value=NMOS_switch
T -600 -1200 5 10 0 1 0 6 1
footprint=sot23-nmos
T -1600 -1200 5 10 0 1 0 6 1
device=NMOS
}
C -600 -2200 1 0 0 gnd-1.sym
...
N -500 -300 -500 0 4
N -500 -1300 -500 -1200 4
C -2200 1700 1 0 1 pmos-switch.sym
{
T -2425 2000 5 8 1 1 0 7 1
refdes=M2
T -2300 2500 5 10 0 1 0 6 1
value=PMOS_switch
T -2700 2300 5 10 0 1 0 6 1
footprint=sot23-pmos
T -3700 2300 5 10 0 1 0 6 1
device=PMOS
}
N -2800 2200 -2800 2400 4
C -1600 1900 1 0 1 in-1.sym
{
T -1600 2400 5 10 0 0 0 6 1
footprint=anchor
T -1600 2200 5 10 0 0 0 6 1
device=INPUT
T -1600 2000 5 10 1 1 0 1 1
refdes=WE
}
N -2800 1650 -2600 1650 4
C -1100 900 1 270 0 resistor-load.sym
{
